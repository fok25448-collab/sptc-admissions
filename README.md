...
## เพิ่มแอนิเมชัน — 13 กันยายน 2569

- หัวข้อและการ์ดค่อย ๆ ปรากฏพร้อมเลื่อนขึ้นเมื่อเข้ามาในจอ
- การ์ดที่โหลดเพิ่มมีแอนิเมชันเรียงจังหวะสั้น ๆ และปุ่มตอบสนองเมื่อแตะ
- แสงพื้นหลังส่วนหัวเคลื่อนช้า ๆ โดยคงสีและรูปภาพเดิม
- แอนิเมชันหยุดเมื่อสลับแท็บ และปิดเมื่อผู้ใช้เลือก Reduce Motion
- ไม่ซ่อนเนื้อหาถ้า JavaScript ใช้ไม่ได้ และไม่เพิ่มเวลารอให้การกรอก/ส่งใบสมัคร

แก้ความเร็วและรูปแบบได้ที่ `public/assets/motion.css` และ `public/assets/motion.js` ใช้ร่วมกันทั้ง 4 หน้า ไม่ต้องรัน SQL ใหม่สำหรับการปรับครั้งนี้
